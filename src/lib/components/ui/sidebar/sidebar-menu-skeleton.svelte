...
<style>
:global(.sidebar-menu-skeleton-text) {
  max-width: 70%;
}
:global(.sidebar-menu-skeleton-text[data-width="50"]) {
  max-width: 50%;
}
:global(.sidebar-menu-skeleton-text[data-width="60"]) {
  max-width: 60%;
}
:global(.sidebar-menu-skeleton-text[data-width="70"]) {
  max-width: 70%;
}
:global(.sidebar-menu-skeleton-text[data-width="80"]) {
  max-width: 80%;
}
:global(.sidebar-menu-skeleton-text[data-width="90"]) {
  max-width: 90%;
}
</style>
